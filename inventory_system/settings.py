...
SECRET_KEY = 'django-insecure-bd12c63j03$f*3$1*t6@%puj4wwflvlo%9^j25f#j5z2-=b=($'
...
# Email settings for sending orders to suppliers
...
DEFAULT_FROM_EMAIL = 'inventory@example.com'  # Замените на ваш email отправителя
